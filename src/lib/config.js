const config = {
  ...
  BASE_URL: process.env.NODE_ENV === 'production' ? `http://localhost:9000` : `http://localhost:9000/api`,
  // IMAGE_URL: process.env.NODE_ENV === 'production' ? `http://15.164.101.160:9000/image` : `http://localhost:9000/image`,
  IMAGE_URL: process.env.NODE_ENV === 'production' ? `http://localhost:9000/image` : `http://localhost:9000/image`,
};
